...
namespace FootballAssociationDB {
	...
	{
	public:
		String^ connectionStr = "Data Source=KassabLaptop;Initial Catalog=Football_Association;Integrated Security=True;";
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ClientSize = System::Drawing::Size(608, 495);
	...
	private: System::Void ClubsForm_Load(System::Object^ sender, System::EventArgs^ e) {
		try {
			...
			while (reader->Read())
			{
				...
				listBox1->Items->Add(reader->GetString(1) + " Managed by: " + reader->GetString(2) + " Founded in the year: " + reader->GetInt32(4) + " Located in: " + reader->GetString(3));
